...
export default function PBBuilder() {
    ...
    // ✅ REPARADO: Lógica de carga para Edición con normalización estricta
    useEffect(() => {
        if (location.state?.deckToEdit) {
            ...
            if (d.format === "primer_bloque") {
                ...
                // Mapeamos quantity (DB) a cantidad (State) para que las funciones lo reconozcan
                const cardsFromDb = d.cards.map(c => ({ 
                    ...c, 
    ...
    // ✅ REPARADO: handleAdd funcional para asegurar reactividad en edición
    const handleAdd = (c) => {
        setMazo(prevMazo => {
    ...
    // ✅ REPARADO: handleRemove funcional
    ...
    const handleTakeScreenshot = async () => {
        ...
        try {
            ...
            if (logo) {
                ...
                ctx.drawImage(logo, 300, 200, 600, 600);
                ctx.globalAlpha = 1.0;
            }
