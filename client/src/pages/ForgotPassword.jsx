...
export default function ForgotPassword() {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1120] flex items-center justify-center p-6 transition-colors duration-500">
            <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] border border-slate-200 dark:border-white/10 p-10 shadow-2xl animate-in fade-in zoom-in-95">
                {!sent ? (
                    <>
                        ...
                        <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest mb-8 italic">Solo para cuentas manuales (No Google).</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="relative group">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-white/10 p-4 pl-12 rounded-2xl outline-none focus:border-blue-600 dark:focus:border-blue-500 transition-all font-bold text-sm uppercase text-slate-900 dark:text-white"
                            ...
                            <button disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-blue-600/20 active:scale-95 transition-all flex items-center justify-center gap-2 italic">
                    ...
                    <div className="text-center py-6">
                        ...
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase mb-2 italic tracking-tighter">Enlace Enviado</h2>
                        <p className="text-slate-400 text-xs font-bold uppercase mb-8 leading-relaxed">Revisa tu correo para realizar el cambio de contraseña obligatorio.</p>
